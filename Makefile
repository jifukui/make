...
ACLOCAL = ${SHELL} /home/jidisk/jifukuistudy/sourcecode/make-3.82/config/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /home/jidisk/jifukuistudy/sourcecode/make-3.82/config/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/jidisk/jifukuistudy/sourcecode/make-3.82/config/missing --run autoconf
AUTOHEADER = ${SHELL} /home/jidisk/jifukuistudy/sourcecode/make-3.82/config/missing --run autoheader
AUTOMAKE = ${SHELL} /home/jidisk/jifukuistudy/sourcecode/make-3.82/config/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/jidisk/jifukuistudy/sourcecode/make-3.82/config/missing --run makeinfo
...
abs_builddir = /home/jidisk/jifukuistudy/sourcecode/make-3.82
abs_srcdir = /home/jidisk/jifukuistudy/sourcecode/make-3.82
abs_top_builddir = /home/jidisk/jifukuistudy/sourcecode/make-3.82
abs_top_srcdir = /home/jidisk/jifukuistudy/sourcecode/make-3.82
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/jidisk/jifukuistudy/sourcecode/make-3.82/config/install-sh
...
loadavg-getloadavg.o: getloadavg.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT loadavg-getloadavg.o -MD -MP -MF $(DEPDIR)/loadavg-getloadavg.Tpo -c -o loadavg-getloadavg.o `test -f 'getloadavg.c' || echo '$(srcdir)/'`getloadavg.c
	$(am__mv) $(DEPDIR)/loadavg-getloadavg.Tpo $(DEPDIR)/loadavg-getloadavg.Po
#	source='getloadavg.c' object='loadavg-getloadavg.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o loadavg-getloadavg.o `test -f 'getloadavg.c' || echo '$(srcdir)/'`getloadavg.c

loadavg-getloadavg.obj: getloadavg.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT loadavg-getloadavg.obj -MD -MP -MF $(DEPDIR)/loadavg-getloadavg.Tpo -c -o loadavg-getloadavg.obj `if test -f 'getloadavg.c'; then $(CYGPATH_W) 'getloadavg.c'; else $(CYGPATH_W) '$(srcdir)/getloadavg.c'; fi`
	$(am__mv) $(DEPDIR)/loadavg-getloadavg.Tpo $(DEPDIR)/loadavg-getloadavg.Po
#	source='getloadavg.c' object='loadavg-getloadavg.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o loadavg-getloadavg.obj `if test -f 'getloadavg.c'; then $(CYGPATH_W) 'getloadavg.c'; else $(CYGPATH_W) '$(srcdir)/getloadavg.c'; fi`
